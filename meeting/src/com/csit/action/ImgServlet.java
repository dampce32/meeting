...
public class ImgServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 1768252314355793018L;
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		setBorder(g);
		setRandomLine(g);
		drawRandomData2(g,request.getSession());
	...
	private void drawRandomData2(Graphics2D g,HttpSession session) {
		...
		g.rotate(0.01);
		session.setAttribute("loginCaptcha", randomData);
